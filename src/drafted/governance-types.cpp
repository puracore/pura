...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "PuraNetwork") type = PuraNetwork;
    if(strType == "PuraNetworkVariable") type = PuraNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == PuraNetwork) s = "PuraNetwork";
    if(type == PuraNetworkVariable) s = "PuraNetworkVariable";
