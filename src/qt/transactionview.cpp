    ...
    transactionView(0)
{
    ...
    typeWidget->addItem(tr("PrivatePay"), TransactionFilterProxy::TYPE(TransactionRecord::PrivatePay));
    typeWidget->addItem(tr("PrivatePay Make Collateral Inputs"), TransactionFilterProxy::TYPE(TransactionRecord::PrivatePayMakeCollaterals));
    typeWidget->addItem(tr("PrivatePay Create Denominations"), TransactionFilterProxy::TYPE(TransactionRecord::PrivatePayCreateDenominations));
    typeWidget->addItem(tr("PrivatePay Denominate"), TransactionFilterProxy::TYPE(TransactionRecord::PrivatePayDenominate));
    typeWidget->addItem(tr("PrivatePay Collateral Payment"), TransactionFilterProxy::TYPE(TransactionRecord::PrivatePayCollateralPayment));
