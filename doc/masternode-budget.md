...
Format: ```mngovernance prepare proposal-name url payment-count block-start pura-address monthly-payment-pura```
...
Format: ```mngovernance submit proposal-name url payment-count block-start pura-address monthly-payment-pura fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using pura.conf setup)
