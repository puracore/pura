...
Sample initialization flow from _pura-qt_ console (this needs to be done only once to set up the association):
 ...
 - Keepass pops up and asks for an association id, fill that in, for example, "_mypurawallet_"
 - You should get a response like this "_Association successful. Id: mypurawalletpura - Key: AgQkcs6cI7v9tlSYKjG/+s8wJrGALHl3jLosJpPLzUE=_"
 - Edit _pura.conf_ and fill in these values
```
keepass=1
keepasskey=AgQkcs6cI7v9tlSYKjG/+s8wJrGALHl3jLosJpPLzUE=
keepassid=mypurawallet
