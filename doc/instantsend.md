...
This mechanism has been integrated into Bitcore-Node-Pura which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/purapay/insight-api-pura#web-socket-api](https://github.com/purapay/insight-api-pura#web-socket-api) 
* API: [https://github.com/purapay/insight-api-pura#instantsend-transactions](https://github.com/purapay/insight-api-pura#instantsend-transactions) 
...
By default, the Pura Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Pura Core daemon:
